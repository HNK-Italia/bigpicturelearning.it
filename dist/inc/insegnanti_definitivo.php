<section class="container mb-5">
  ...
  <!-- Inizio delle cards Insegnanti -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3">
      <img src="foto_davide.JPG" style="width: 200px; height: 200px; border-radius: 50%; margin-bottom: 20px;" />
  ...
  <!-- Inizio di una card e fine di un'altra -->
    ...
    <div class="col-mx-12 col-md-6 col-lg-3">
      <img src="foto_giulia.png" style="width: 200px; height: 200px; border-radius: 50%; margin-bottom: 20px;" />
      <h5 style="color: #1CA554; margin-bottom: 15px;">Giulia Ghisio</h4>
      <h6>Insegnante di Italiano</h6>
    </div>
