  ...
  <section class="container mb-5">
    <div class="center card-deck">
      <div class="card text-center bpl-card">
        <div class="bpl-card-img-top img-background-little" style="background: url('foto_davide.png'); background-size: cover; background-position: 50% 25%;" alt="Card image cap"></div>
        <div class="card-body">
